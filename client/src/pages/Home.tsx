...
const fallbackSettings = {
  siteName: "Blue Decor", brandLine: "Celebrations, styled beautifully", heroEyebrow: "Events made memorable", heroTitle: "Make the moment", heroAccent: "feel unforgettable.", heroIntro: "Friendly, thoughtful décor for weddings, birthdays, graduations, baby showers, and every beautiful reason to gather.", heroCtaLabel: "Plan your celebration", heroImageUrl: "/images/blue-decore/celebration-reference.jpg", heroAsideTitle: "Weddings • birthdays • graduations", heroAsideBody: "One warm studio for the moments your people will remember.", heroFooterIndex: "01 / 06", heroFooterDescriptor: "Event décor + joyful details + beautiful memories", tickerItems: "Weddings|Birthdays|Graduations|Baby showers|Special occasions", aboutEyebrow: "The Blue Decor approach", aboutRailLabel: "About the studio", aboutTitle: "Beautiful details", aboutAccent: "for every reason.", aboutBody: "We create welcoming celebration spaces with a confident blue point of view, thoughtful details, and a friendly process from first idea to final photo.", aboutQuote: "The best décor makes people feel at home in the moment.", aboutImageUrl: "/images/blue-decore/weddings.jpg", aboutCaptionLeft: "Blue tablescape / Event styling", aboutCaptionRight: "Joy, detail, and a little sparkle", programsEyebrow: "Celebration collections", programsRailLabel: "Choose your moment", programsTitle: "A beautiful setting", programsAccent: "starts here.", programsSummary: "Tell us what you are celebrating and we will shape the colors, details, and atmosphere around it.", audioImageLabel: "Blue Decor / Celebration mood", audioCaptionLabel: "A little inspiration", servicesEyebrow: "What we style", servicesRailLabel: "Décor for every occasion", servicesTitle: "Bring your people", servicesAccent: "we’ll bring the magic.", servicesSummary: "From intimate family moments to proud student milestones, we make the room feel as special as the reason you gathered.", eventEyebrow: "Next celebration", eventTitle: "Your moment", eventAccent: "deserves the details.", eventBody: "Whether it is your wedding day, a birthday surprise, a graduation party, or a baby shower, Blue Decor is here to make it feel warm, joyful, and completely yours.", eventCtaLabel: "Start planning", eventImageUrl: "/images/blue-decore/graduations.jpg", eventImageLabel: "Blue-forward celebration / Photo-ready", journalEyebrow: "Notes from the studio", journalRailLabel: "Ideas for your day", journalTitle: "Little details", journalAccent: "big feeling.", contactEyebrow: "Let’s make a plan", contactRailLabel: "Start your celebration", contactTitle: "Tell us", contactAccent: "what you’re dreaming.", contactBody: "Share the occasion, the date, and the feeling you want your guests to leave with.", contactEmail: "hello@bluedecor.et", contactLocation: "Addis Ababa, Ethiopia", instagramUrl: "https://instagram.com", youtubeUrl: "https://youtube.com", facebookUrl: "https://facebook.com", footerNavigateLabel: "Navigate", footerFollowLabel: "Follow the signal", footerBuiltLine: "Styled with care / Made for your people"
};
...
export default function Home() {
  ...
  const journalEntries = apiJournalEntries.length ? apiJournalEntries : [{ id: 1, title: "A celebration starts with a feeling", category: "Studio note", dateLabel: "Blue Decor / 01" }, { id: 2, title: "The little details guests remember", category: "Ideas", dateLabel: "Blue Decor / 02" }, { id: 3, title: "Making room for your people", category: "Planning", dateLabel: "Blue Decor / 03" }];
