...
function ServiceEditor({ value, onChange, onClose, onSave, saving }: any) { return <EditorSheet title={value.id ? "Edit service" : "Add service"} description="Describe what Kasha can make, choose a visual signal, and set its image." onClose={onClose} onSave={onSave} saving={saving}><EditorFields value={value} onChange={onChange} fields={[["title", "Service title"], ["iconKey", "Icon", "select", ["mic", "camera", "calendar", "radio", "sparkles", "film"]], ["imageUrl", "Service image URL"], ["sortOrder", "Display order", "number"], ["description", "Description", "long"], ["isPublished", "Publish now", "boolean"]]} /></EditorSheet>; }
